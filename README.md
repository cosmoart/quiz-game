...
By default the project detects if you are in development or production environment. If you are in development environment, the questions are pre-generated and stored in `source_code/src/helpers/devQuestions.js`.
