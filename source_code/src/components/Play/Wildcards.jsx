			...
			<nav>
				<ul className='flex gap-4 lg:flex-col'>
					...
					<li className={`relative ${wildCards.half < 1 ? "grayscale cursor-not-allowed" : "hover:scale-105"}`}>
						<button onClick={wilcardFifty} className='p-[10px] aspect-square rounded text-white bg-blue-500 w-full  transition-transform text' title='Fifty fifty' disabled={wildCards.half < 1}>
							50
						</button>
